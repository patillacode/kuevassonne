...
def records(request):
    ...
    for game in all_games:
        ...
        if (
            ...
            streak_data[winner]['current_win_streak'] = 0
        ...
        if (
            ...
            streak_data[loser]['current_loss_streak'] = 0
    ...
    best_wr_player = all_players.order_by(
        '-win_rate', '-wins', 'average_position'
    ).first()
    ...
    context = {'achievements': achievements, 'records': Record.objects.all()}
